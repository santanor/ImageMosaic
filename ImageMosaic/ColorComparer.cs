...
namespace ImageMosaic
{
    class ColorComparer
        ...
        public ColorComparer(int R, int G, int B)
        {
            RGBtoLAB(R, G, B);
        }
        ...
        ///
        /// 
        public int CompareTo(ColorComparer oComparisionColor)
        {
        ...
        {
            ColorComparer oColor1 = new ColorComparer(R1, G1, B1);
            ColorComparer oColor2 = new ColorComparer(R2, G2, B2);
